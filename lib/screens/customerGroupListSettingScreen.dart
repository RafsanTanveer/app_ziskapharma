...
class CustomerGroupListSettingScreen extends StatefulWidget {
  const CustomerGroupListSettingScreen({super.key});

  @override
  State<CustomerGroupListSettingScreen> createState() =>
      _CustomerGroupListSettingScreen();
}

class _CustomerGroupListSettingScreen
    extends State<CustomerGroupListSettingScreen> {
